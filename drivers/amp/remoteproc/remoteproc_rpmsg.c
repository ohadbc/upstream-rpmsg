				    ...
				    const char *name)
{
	...
	dev_info(rproc->dev, "vring%d: va %p qsz %d\n", id, addr, len);
...
/**
 * rproc_add_rpmsg_vdev() - create an rpmsg vdev device for this rproc
 ...
 * but the plans are to remove this limitation. At that point this interface
 ...
 * @rproc: the rproc handle
 *
 * This function is called whenever @rproc is removed iff an rpmsg
